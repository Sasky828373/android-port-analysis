...
static bool hasUsableEnginePresentSource(){return lastCompatFinalTransferDst.load(std::memory_order_acquire)!=nullptr||lastCompatFullSizeRTV.load(std::memory_order_acquire)!=nullptr;}
